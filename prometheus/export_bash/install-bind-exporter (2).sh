...
eof
	...
	cd  ${installdir} && wget http://soft.kyepm.com/prometheus/bind-exporter
...
#	rm -f /lib/systemd/system/bind-exporter.service
	curl --request PUT  http://consul.ky-tech.com.cn/v1/agent/service/deregister/$(hostname)-${ipaddr}-bindexporter
else
