...
eof
	...
	cd  ${installdir} && wget http://soft.kyepm.com/prometheus/process-exporter
...
#	rm -f /lib/systemd/system/process-exporter.service
	curl --request PUT  http://consul.ky-tech.com.cn/v1/agent/service/deregister/$(hostname)-${ipaddr}-process
else
