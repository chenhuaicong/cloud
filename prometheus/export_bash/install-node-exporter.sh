...
cd  ${installdir}/ && wget http://soft.kyepm.com/prometheus/node-exporter
...
#	rm -f /lib/systemd/system/node-exporter.service
	curl --request PUT  http://consul.ky-tech.com.cn/v1/agent/service/deregister/$(hostname)-${ipaddr}-node-exporter
else
