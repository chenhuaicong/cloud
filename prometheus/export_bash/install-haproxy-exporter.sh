...
eof
        ...
        cd  ${installdir} && wget http://soft.kyepm.com/prometheus/haproxy-exporter
...
#        rm -f /lib/systemd/system/haproxy-exporter.service
        curl --request PUT  http://consul.ky-tech.com.cn/v1/agent/service/deregister/$(hostname)-${ipaddr}-haproxy-exporter
else
